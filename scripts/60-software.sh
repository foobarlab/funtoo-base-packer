...
# add bash-completion
sudo emerge -nvt app-shells/bash-completion

# add zsh 
sudo emerge -nvt app-shells/zsh app-shells/zsh-completions app-doc/zsh-lovers
...
sudo emerge -nvt media-fonts/terminus-font
BUILD_FONT="ter-116b"
export BUILD_FONT
